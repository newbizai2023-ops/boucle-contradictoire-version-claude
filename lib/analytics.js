...
export function buildAnalytics(runs = []) {
  ...
  return {
    totals: {
      ...
      // Analyses dont le processus a disparu avant la fin : elles ne sont ni validees, ni rejetees,
      // ni en echec declare. Sans ce compteur elles gonflaient le total sans apparaitre nulle part,
      // et le cout qu'elles ont engage passait pour celui d'analyses abouties.
